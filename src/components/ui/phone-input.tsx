...
export function PhoneInput({ value, onChange, placeholder = '201-555-0123', className = '' }: PhoneInputProps) {
    ...
    <div className={`flex gap-2 ${className}`}>
      ...
      <div ref={dropdownRef} className="relative">
        <Button
          ...
          className="h-10 px-3 gap-2 bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800"
        >
          <span className="text-base leading-none">{selectedCountry.flag}</span>
          <span className="text-sm text-gray-600 dark:text-gray-400">{selectedCountry.dialCode}</span>
          <ChevronDown className={`w-4 h-4 text-gray-400 transition-transform ${isOpen ? 'rotate-180' : ''}`} />
        </Button>

        {/* Dropdown Menu */}
        {isOpen && (
          <div className="absolute top-full left-0 mt-1 w-[320px] bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl z-[100] overflow-hidden">
            {/* Search Input */}
            <div className="p-3 border-b border-gray-200 dark:border-gray-700">
              <Input
                ...
                placeholder="Search"
                className="h-9 bg-gray-50 dark:bg-gray-900 border-gray-200 dark:border-gray-700 text-sm"
                autoFocus
              />
            </div>
            ...
            <div className="max-h-[280px] overflow-y-auto">
              {filteredCountries.map((country) => (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-2.5 text-left transition-colors hover:bg-gray-50 dark:hover:bg-gray-700/50 ${
