...
type ClientPortalSettingsHubViewProps = {
  children: React.ReactNode;
};

export function ClientPortalSettingsHubView({ children }: ClientPortalSettingsHubViewProps) {
  ...
  return (
    <div className="flex-1 flex min-w-0 overflow-hidden">
      ...
      <div className="w-72 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex flex-col overflow-hidden">
        ...
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-gray-900 dark:text-gray-100 font-semibold">Client & Portal</h2>
              <p className="text-xs text-gray-600 dark:text-gray-400">Client-facing settings</p>
            </div>
          </div>
        </div>
            ...
            {subsections.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  {item.badge && (
                    <span className="ml-auto text-xs px-2 py-0.5 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300">
                      {item.badge}
                    </span>
                  )}
                </button>
      ...
      {/* Main Content Area */}
      <div className="flex-1 overflow-auto bg-gradient-to-br from-gray-50 via-blue-50/20 to-gray-50 dark:from-gray-900 dark:via-blue-950/10 dark:to-gray-900">
        {children}
      </div>
    </div>
  );
