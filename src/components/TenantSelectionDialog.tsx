...
export function TenantSelectionDialog({ open, onOpenChange, onTenantSelected }: TenantSelectionDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md" aria-describedby="tenant-selection-description">
        <DialogHeader>
          <DialogTitle style={{ color: branding.colors.headingText }}>
            Change Tenant
          </DialogTitle>
          <DialogDescription style={{ color: branding.colors.mutedText }} id="tenant-selection-description">
