...
export function DemographicsTab({ client }: DemographicsTabProps) {
  ...
  const visibleCardsCount = client.type === 'Individual'
    ? Object.values(individualCardVisibility).filter(Boolean).length
    : Object.values(businessCardVisibility).filter(Boolean).length;
          ...
          <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                  <ConsolidatedDemographicsCard
                    ...
                    isEditing={editingCard === 'demographics'}
                    onEdit={() => setEditingCard(editingCard === 'demographics' ? null : 'demographics')}
              ...
              {/* SSN Card - Now integrated into Demographics card above */}
              {false && individualCardVisibility.ssn && (
                <SSNCard
                  ssn={demographics.ssn}
                  onRequestView={() => handleRequestSensitiveFieldAccess('ssn', 'demographics')}
                  isUnlocked={isSensitiveFieldUnlocked('ssn')}
                  isEditing={editingCard === 'ssn'}
                  onEdit={() => setEditingCard(editingCard === 'ssn' ? null : 'ssn')}
                  onSave={() => handleSaveCard('ssn')}
                  onCancel={handleCancelEdit}
                  onChange={(newSSN) => setDemographics({ ...demographics, ssn: newSSN })}
                />
              )}

              {/* OLD CARDS - Hidden temporarily */}
              {false && individualCardVisibility.personalInfo && (
                <DemographicCard
                  title="Personal Information"
                  icon={<UserCircle className="w-4 h-4 text-purple-600" />}
                  isEditing={editingCard === 'personalInfo'}
                  onEdit={() => setEditingCard(editingCard === 'personalInfo' ? null : 'personalInfo')}
                  onSave={() => handleSaveCard('personalInfo')}
                  onCancel={handleCancelEdit}
                  viewContent={
                    <div className="p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 space-y-3">
                      ...
                      <InfoRow label="Preferred Name" value={personalInfo.preferredName} />
                      {personalInfo.suffix && <InfoRow label="Suffix" value={personalInfo.suffix} />}
                    </div>
                  }
                  editContent={
              ...
              {/* Demographics Card - OLD - Hidden */}
              {false && individualCardVisibility.demographics && (
                <DemographicCard
                  title="Demographics"
                  ...
                  viewContent={
                    <div className="p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 space-y-3">
                      <InfoRow label="Date of Birth" value={demographics.dateOfBirth} icon={<Calendar className="w-4 h-4 text-gray-400" />} />
                      <InfoRow 
                        label="SSN" 
                      ...
                      <InfoRow label="Citizenship" value={demographics.citizenship} />
                    </div>
                  }
                  editContent={
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                          ...
                          <div className="flex gap-2 mt-1">
                            <Input
                              id="ssn"
                              value={isSensitiveFieldUnlocked('ssn') ? demographics.ssn : demographics.ssn}
                              onChange={(e) => setDemographics({ ...demographics, ssn: e.target.value })}
                              placeholder="XXX-XX-XXXX"
                              disabled={!isSensitiveFieldUnlocked('ssn')}
                              className="flex-1"
                            />
                            {!isSensitiveFieldUnlocked('ssn') && (
                              <Button
                                type="button"
                                size="sm"
                                variant="outline"
                                onClick={() => handleRequestSensitiveFieldAccess('ssn', 'demographics')}
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <Select value={demographics.gender} onValueChange={(val) => setDemographics({ ...demographics, gender: val })}>
                        ...
                        <div>
                          ...
                          <Select value={demographics.maritalStatus} onValueChange={(val) => setDemographics({ ...demographics, maritalStatus: val })}>
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setDemographics({ ...demographics, citizenship: e.target.value })}
                          className="mt-1"
                        />
                      </div>
                    </div>
              ...
              {/* Contact Information Card - OLD - Hidden */}
              {false && individualCardVisibility.contactInfo && (
                <DemographicCard
                  title="Contact Information"
                  icon={<Phone className="w-4 h-4 text-purple-600" />}
                  isEditing={editingCard === 'contactInfo'}
                  onEdit={() => setEditingCard(editingCard === 'contactInfo' ? null : 'contactInfo')}
                  onSave={() => handleSaveCard('contactInfo')}
                  onCancel={handleCancelEdit}
                  viewContent={
                    <div className="p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 space-y-3">
                      <InfoRow label="Email" value={contactInfo.email} icon={<Mail className="w-4 h-4 text-gray-400" />} />
                      <InfoRow label="Phone" value={contactInfo.phone} icon={<Phone className="w-4 h-4 text-gray-400" />} />
                      <InfoRow label="Alternate Phone" value={contactInfo.alternatePhone} icon={<Phone className="w-4 h-4 text-gray-400" />} />
                      <Separator />
                      <div>
                        <div className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Address</div>
                        <div className="text-sm text-gray-900 dark:text-gray-100">
                          {contactInfo.address1}
                          {contactInfo.address2 && <>, {contactInfo.address2}</>}
                        </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                          ...
                          <PhoneInput
                            ...
                            onChange={(val) => setContactInfo({ ...contactInfo, alternatePhone: val })}
                            className="mt-1"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-6 gap-2">
                        ...
                        <div className="col-span-1">
                          ...
                          <Select value={contactInfo.state} onValueChange={(val) => setContactInfo({ ...contactInfo, state: val })}>
              ...
              {individualCardVisibility.otherContacts && (
                <DemographicCard
                  ...
                  isEditing={editingCard === 'otherContacts'}
                  onEdit={() => setEditingCard(editingCard === 'otherContacts' ? null : 'otherContacts')}
              ...
              {individualCardVisibility.drivingLicense && (
                <DriverLicenseCard
                  data={drivingLicense}
                  isEditing={editingCard === 'drivingLicense'}
                  onEdit={() => setEditingCard(editingCard === 'drivingLicense' ? null : 'drivingLicense')}
              ...
              {individualCardVisibility.bankAccount && (
                <BankAccountCard
                  data={bankAccount}
                  isEditing={editingCard === 'bankAccount'}
                  onEdit={() => setEditingCard(editingCard === 'bankAccount' ? null : 'bankAccount')}
              ...
              {individualCardVisibility.dependents && (
                <DemographicCard
                  ...
                  isEditing={editingCard === 'dependents'}
                  onEdit={() => setEditingCard(editingCard === 'dependents' ? null : 'dependents')}
          ...
          <div className="grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                <ConsolidatedBusinessDemographicsCard
                    ...
                    isEditing={editingCard === 'companyInfo'}
                    onEdit={() => setEditingCard(editingCard === 'companyInfo' ? null : 'companyInfo')}
              ...
              {/* EIN Card - Now integrated into Company Demographics card above */}
              {false && businessCardVisibility.ein && (
                <EINCard
                  ein={companyInfo.ein}
                  onRequestView={() => handleRequestSensitiveFieldAccess('ein', 'companyInfo')}
                  isUnlocked={isSensitiveFieldUnlocked('ein')}
                  isEditing={editingCard === 'ein'}
                  onEdit={() => setEditingCard(editingCard === 'ein' ? null : 'ein')}
                  onSave={() => handleSaveCard('ein')}
                  onCancel={handleCancelEdit}
                  onChange={(newEIN) => setCompanyInfo({ ...companyInfo, ein: newEIN })}
                />
              )}

              {/* OLD CARDS - Hidden temporarily */}
              {false && businessCardVisibility.primaryContact && (
                <DemographicCard
                  title="Primary Contact Information"
                  icon={<UserCircle className="w-4 h-4 text-purple-600" />}
                  isEditing={editingCard === 'primaryContact'}
                  onEdit={() => setEditingCard(editingCard === 'primaryContact' ? null : 'primaryContact')}
                  onSave={() => handleSaveCard('primaryContact')}
                  onCancel={handleCancelEdit}
                  viewContent={
                    <div className="p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 space-y-3">
                      <InfoRow label="Contact Person" value={primaryContact.contactPerson} icon={<User className="w-4 h-4 text-gray-400" />} />
                      <InfoRow label="Title" value={primaryContact.title} />
                      <InfoRow label="Email" value={primaryContact.email} icon={<Mail className="w-4 h-4 text-gray-400" />} />
                      <InfoRow label="Phone" value={primaryContact.phone} icon={<Phone className="w-4 h-4 text-gray-400" />} />
                      <InfoRow label="Alternate Phone" value={primaryContact.alternatePhone} icon={<Phone className="w-4 h-4 text-gray-400" />} />
                    </div>
                  }
                  editContent={
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setPrimaryContact({ ...primaryContact, contactPerson: e.target.value })}
                            className="mt-1"
                          />
                        </div>
                        <div>
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <PhoneInput
                            ...
                            onChange={(val) => setPrimaryContact({ ...primaryContact, phone: val })}
                            className="mt-1"
                          />
                        </div>
                        <div>
                          ...
                          <PhoneInput
                            id="altPhone"
                            value={primaryContact.alternatePhone}
                            onChange={(val) => setPrimaryContact({ ...primaryContact, alternatePhone: val })}
                            className="mt-1"
                          />
                        </div>
                      </div>
              ...
              {businessCardVisibility.businessOtherContacts && (
                <DemographicCard
                  ...
                  isEditing={editingCard === 'businessOtherContacts'}
                  onEdit={() => setEditingCard(editingCard === 'businessOtherContacts' ? null : 'businessOtherContacts')}
              ...
              {/* Company Information Card - Part 1 - OLD - Hidden */}
              {false && businessCardVisibility.companyInfo && (
                <DemographicCard
                  ...
                  onCancel={handleCancelEdit}
                  viewContent={
                    <div className="p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 space-y-3 max-h-[400px] overflow-y-auto">
                      <InfoRow label="Legal Name" value={companyInfo.legalName} />
                      <InfoRow label="DBA" value={companyInfo.dbaName} />
                      <InfoRow 
                        label="EIN" 
                        ...
                        masked 
                      />
                      <InfoRow label="Entity Type" value={companyInfo.entityType} />
                      <InfoRow label="Entity Number" value={companyInfo.entityNumber} />
                      <Separator />
                      <InfoRow label="State of Incorporation" value={companyInfo.stateOfIncorporation} />
                      <InfoRow label="Incorporation Date" value={companyInfo.incorporationDate} />
                      <InfoRow label="Business Start Date" value={companyInfo.businessStartDate} />
                      <Separator />
                      <InfoRow label="Industry" value={companyInfo.industry} />
                      <InfoRow label="Business Activity" value={companyInfo.businessActivity} />
                      <InfoRow label="Total Employees" value={companyInfo.totalEmployees} />
                      <Separator />
                      <div>
                        <div className="text-xs font-medium text-gray-500 uppercase tracking-wide mb-1">Business Address</div>
                        <div className="text-sm text-gray-900 dark:text-gray-100">
                    ...
                    <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2">
                      ...
                      <div>
                        ...
                        <div className="flex gap-2 mt-1">
                          <Input
                            id="ein"
                            value={isSensitiveFieldUnlocked('ein') ? companyInfo.ein : companyInfo.ein}
                            onChange={(e) => setCompanyInfo({ ...companyInfo, ein: e.target.value })}
                            placeholder="XX-XXXXXXX"
                            disabled={!isSensitiveFieldUnlocked('ein')}
                            className="flex-1"
                          />
                          {!isSensitiveFieldUnlocked('ein') && (
                            <Button
                              type="button"
                              size="sm"
                              variant="outline"
                              onClick={() => handleRequestSensitiveFieldAccess('ein', 'companyInfo')}
                              className="h-10 px-3 text-xs gap-1.5 border-purple-200 dark:border-purple-800 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20 whitespace-nowrap"
                            >
                              <Shield className="w-3.5 h-3.5" />
                              View & Edit
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <Input
                            id="entityNumber"
                            value={companyInfo.entityNumber}
                            onChange={(e) => setCompanyInfo({ ...companyInfo, entityNumber: e.target.value })}
                            className="mt-1"
                          />
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-3">
                        <div>
                          ...
                          <Select value={companyInfo.entityType} onValueChange={(val) => setCompanyInfo({ ...companyInfo, entityType: val })}>
                        ...
                        <div>
                          <Label htmlFor="stateInc">State of Incorporation</Label>
                          <Select value={companyInfo.stateOfIncorporation} onValueChange={(val) => setCompanyInfo({ ...companyInfo, stateOfIncorporation: val })}>
                            <SelectTrigger id="stateInc" className="mt-1">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                              {US_STATES.map(state => (
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setCompanyInfo({ ...companyInfo, totalEmployees: e.target.value })}
                            className="mt-1"
                          />
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-6 gap-2">
                        ...
                        <div className="col-span-1">
                          <Label htmlFor="state">State</Label>
                          <Select value={companyInfo.state} onValueChange={(val) => setCompanyInfo({ ...companyInfo, state: val })}>
                            <SelectTrigger id="state" className="mt-1">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
              ...
              {/* Business Bank Account Card - New Version */}
              {businessCardVisibility.businessBankAccount && (
                <BankAccountCard
                  data={businessBankAccount}
                  isEditing={editingCard === 'businessBankAccount'}
                  onEdit={() => setEditingCard(editingCard === 'businessBankAccount' ? null : 'businessBankAccount')}
              ...
              {businessCardVisibility.withholdings && (
                <DemographicCard
                  ...
                  isEditing={editingCard === 'withholdings'}
                  onEdit={() => setEditingCard(editingCard === 'withholdings' ? null : 'withholdings')}
                      ...
                      {withholdings.map((withholding, index) => (
                        <div key={withholding.id} className="p-3 border border-gray-200 dark:border-gray-700 rounded-lg bg-gray-50/50 dark:bg-gray-800/50 space-y-3">
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            >
                              <SelectTrigger>
                                <SelectValue placeholder="Withholdings State" />
                              </SelectTrigger>
                              <SelectContent>
                                {US_STATES.map(state => (
                                  <SelectItem key={state} value={state}>{state}</SelectItem>
              ...
              {businessCardVisibility.licenses && (
                <DemographicCard
                  ...
                  isEditing={editingCard === 'licenses'}
                  onEdit={() => setEditingCard(editingCard === 'licenses' ? null : 'licenses')}
                      ...
                      {licenses.length === 0 ? (
                        ...
                        licenses.map((license) => (
                          <div key={license.id} className="p-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
                            ...
                            <div className="text-xs text-gray-500 dark:text-gray-400">
                              {license.issuingState} • Start: {license.startDate} • End: {license.endDate}
                            </div>
                          </div>
                        ))
                      )}
              ...
              {businessCardVisibility.salesTaxAccounts && (
                <DemographicCard
                  ...
                  isEditing={editingCard === 'salesTaxAccounts'}
                  onEdit={() => setEditingCard(editingCard === 'salesTaxAccounts' ? null : 'salesTaxAccounts')}
