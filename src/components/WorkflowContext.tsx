...
const initialTasks: ProjectTask[] = [
  ...
  // Additional tasks with blocked status and diverse priorities
  {
    id: "task-23",
    name: "Audit financial statements",
    description: "Complete annual financial statement audit",
    projectId: "client-2",
    workflowId: "workflow-accounting",
    stageId: "stage-3",
    assignee: "Mike Wilson",
    ...
    comments: 5,
    attachments: 8,
    subtasks: { total: 6, completed: 3 },
  },
  {
    id: "task-24",
    name: "Prepare year-end closing entries",
    description: "Review and prepare all year-end closing journal entries",
    projectId: "client-3",
    workflowId: "workflow-accounting",
    stageId: "stage-2",
    assignee: "David Chen",
    priority: "medium",
    status: "blocked",
    dueDate: new Date(2025, 10, 22).toISOString(),
    createdAt: new Date(2025, 10, 8).toISOString(),
    automations: 0,
  ...
  },
  {
    ...
    description: "Review and update vendor service contracts",
    projectId: "client-1",
    workflowId: "workflow-accounting",
    stageId: "stage-1",
    assignee: "Emily Brown",
    priority: "low",
    status: "in-progress",
    dueDate: new Date(2025, 10, 19).toISOString(),
  ...
  {
    id: "task-26",
    name: "Process employee reimbursements",
    description: "Review and process pending employee expense reimbursements",
    projectId: "client-4",
    workflowId: "workflow-sales",
    stageId: "stage-s2",
    assignee: "Sarah Johnson",
  ...
  {
    id: "task-27",
    name: "Update client portal access",
    description: "Grant and configure client portal access for new clients",
    projectId: "client-5",
    workflowId: "workflow-sales",
    stageId: "stage-s4",
    assignee: "John Smith",
    priority: "low",
    status: "in-progress",
    dueDate: new Date(2025, 10, 17).toISOString(),
    createdAt: new Date(2025, 10, 9).toISOString(),
    automations: 0,
    dependencies: [],
    comments: 0,
    attachments: 0,
